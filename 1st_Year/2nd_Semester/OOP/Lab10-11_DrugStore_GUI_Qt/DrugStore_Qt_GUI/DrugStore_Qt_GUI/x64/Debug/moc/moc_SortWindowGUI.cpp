/****************************************************************************
** Meta object code from reading C++ file 'SortWindowGUI.h'
**
...
#error "The header file 'SortWindowGUI.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 11, 19), // "sortDetailsSelected"
QT_MOC_LITERAL(2, 31, 0) // ""

    },
    "SortWindow\0sortDetailsSelected\0"
};
...
void SortWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sortDetailsSelected((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SortWindow::*)(QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SortWindow::sortDetailsSelected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SortWindow::sortDetailsSelected(QString _t1, QString _t2)
{
